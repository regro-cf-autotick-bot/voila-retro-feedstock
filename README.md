...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/voila-retro-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14993&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/voila-retro-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `voila-retro` can be installed with:

```
conda install voila-retro
```

It is possible to list all of the versions of `voila-retro` available on your platform with:
